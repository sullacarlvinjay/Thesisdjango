...
urlpatterns = [
    ...
    path('unifast/archives/columns/', student_views.unifast_archive_columns),
    ...
    path('unifast/tes-applications/report/', student_views.unifast_tes_applicants_report),
    ...
    path('unifast/reports/download/tdp/', student_views.unifast_report_download_tdp),
    path('unifast/reports/preview/tdp/', student_views.unifast_report_preview_tdp),
